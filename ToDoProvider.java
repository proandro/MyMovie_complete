...
public class ToDoProvider extends ContentProvider {
    ...
    public static final String AUTHORITY = "com.example.lucky.myapplication";
    ...
    public static final String MIME_TYPE_1 = ContentResolver.CURSOR_DIR_BASE_TYPE + "/" + "vnd.com.example.lucky.myapplication.todos";
    public static final String MIME_TYPE_2 = ContentResolver.CURSOR_DIR_BASE_TYPE + "/" + "vnd.com.example.lucky.myapplication.todos.place";
    public static final String MIME_TYPE_3 = ContentResolver.CURSOR_ITEM_BASE_TYPE + "/" + "vnd.com.example.lucky.myapplication.todocount";
    ...
    private ToDoListDBAdapter mydb;
    ...
    public boolean onCreate() {
        mydb = ToDoListDBAdapter.getToDoListDBAdapterInstance(getContext());
        return true;
    }
   ...
   public Cursor query(@NonNull Uri uri, @Nullable String[] strings, @Nullable String s, @Nullable String[] strings1, @Nullable String s1) {
        ...
        switch (MATCHER.match(uri)) {
            case TODOS_LIST:
                cursor = mydb.getCursorsForAllToDos();
                break;
            case TODOS_FROM_SPECIFIC_PLACE:
                cursor = mydb.getCursorForSpecificPlace(strings1[0]);
                break;
            case TODOS_COUNT:
                cursor = mydb.getCount();
                break;
    ...
    public int update(@NonNull Uri uri, @Nullable ContentValues contentValues, @Nullable String s, @Nullable String[] strings) throws UnsupportedOperationException {
        ...
        switch (MATCHER.match(uri)) {
            case TODOS_LIST:
                ...
                break;
            default:
                new UnsupportedOperationException("Insertion not successful");
                break;
        }
        return updateCount;
    }
